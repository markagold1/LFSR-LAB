function [fill,Tm] = lfsr_ssgm_jump(jump,poly,ifill)
% Usage: [fill,Tm] = lfsr_ssgm_jump(jump,poly,ifill)
%
% Compute the state space generator transition matrix and 
...
%        fill state
% TM.....State space generator transition matrix
...
% Example:
%
%  [seq,Tm]=lfsr_ssgm_jump(15,[5,3,0],1);
%
